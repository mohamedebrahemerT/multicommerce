        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="basicform_with_reload" action="{{ route('admin.counteries.update',$post->id) }}" method="post">
  ...
  @csrf
          @method('PUT')
 					...
 					<div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control" required="" name="currency"  value="{{$post->currency}}">
                            </div>
                        </div>
					...
					<div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control" required="" name="code"  value="{{$post->code}}">
                            </div>
                        </div>
          ...
          <div class="col-sm-12 col-md-7">
           ...
           <img src="{{url('/')}}/uploads/{{$post->id}}/logo_country.png" style="width: 50px;height: 50px;">
          </div>
        </div -->
