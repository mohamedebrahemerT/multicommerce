  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
       ...
       <div class="form-group row mb-4">
         <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 text-primary" >{{ __('ChatCode') }}</label>
          <div class="col-sm-12 col-md-7">
            <input type="text" class="form-control" required="" name="ChatCode" placeholder="12345678" value="{{ $info->ChatCode ?? '' }}">
          </div>
        </div>
        ...
        <div class="form-group row mb-4">
         <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 text-primary" >{{ __('PixcelInsta') }}</label>
          <div class="col-sm-12 col-md-7">
            <input type="text" class="form-control" required="" name="PixcelInsta" placeholder="12345678" value="{{ $info->PixcelInsta ?? '' }}">
          </div>
        </div>


        <div class="form-group row mb-4">
         <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 text-primary" >{{ __('PixcelTwiter') }}</label>
          <div class="col-sm-12 col-md-7">
            <input type="text" class="form-control" required="" name="PixcelTwiter" placeholder="12345678" value="{{ $info->PixcelTwiter ?? '' }}">
          </div>
        </div>

        <div class="form-group row mb-4">
         <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 text-primary" >{{ __('PixcelSnap') }}</label>
          <div class="col-sm-12 col-md-7">
            <input type="text" class="form-control" required="" name="PixcelSnap" placeholder="12345678" value="{{ $info->PixcelSnap ?? '' }}">
          </div>
        </div>
        
  <div class="form-group row mb-4">
         <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 text-primary" >{{ __('PixcelTecToc') }}</label>
          <div class="col-sm-12 col-md-7">
            <input type="text" class="form-control" required="" name="PixcelTecToc" placeholder="12345678" value="{{ $info->PixcelTecToc ?? '' }}">
          </div>
        </div>
