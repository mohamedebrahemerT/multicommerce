...
@section('content')
 ...
 <img src="{{ url('/') }}/frontend/bigbag/images/profile.jpg" class="mr-2" alt="photo here">
                ...
                {{ \Illuminate\Support\Str::limit($addresse->Address, 20, $end='...') }}
                            ...
                            <a href="#" data-toggle="modal"
                                    data-target="#exampleModaladdresses{{$addresse->id}}"><span class="ti-pencil-alt mr-3"></span></a>
...
<!------------------------------------------------------------------------------------------->
 <!-- Modal -->
    <div class="modal fade" id="exampleModaladdresses{{$addresse->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-xs-12">
                            ...
                            <hr>
                            <form action="{{url('/')}}/user/addresses_update" method="post">
                                @csrf
                         ...
                         <input placeholder="" type="text" name="Phone" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"  value="{{$addresse->Phone}}" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="country-select clearfix">
                                                ...
                                                <select class="nice-select wide" name="CountryCode">
                                                    <option data-display="{{$addresse->CountryCode}}">{{$addresse->CountryCode}}</option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="checkout-form-list">
                                                ...
                                                <input placeholder="" type="text" name="PO" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"  value="{{$addresse->PO}}" />
                                            </div>
                                        </div>
                             ...
                             <option data-display=" @if(Session::get('locale') == 'ar') 
                                  ...
                                  @endif
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @foreach(App\Models\city::get() as $city )
                                                    ...
                                                    <option value=" @if(Session::get('locale') == 'ar') 

                                 {{ $city->name_ar}}
                                  @else
{{ $city->name_en}}

                                  @endif"> @if(Session::get('locale') == 'ar') 
                                  ...
                                  @endif</option>
                                        ...
                                        <div class="col-md-12">
                                            <div class="checkout-form-list">
                                                ...
                                                <input  type="text" name="Address" value="{{$addresse->Address}}">
                                            </div>
                                        </div>
                                ...
                                <div class="checkbox-form">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="checkout-form-list">
                                                <label>{{__('Phone')}} <span class="required">*</span></label>
                         <input placeholder="" type="text" name="Phone" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="checkout-form-list">
                                                <label>{{__('PO')}} <span class="required">*</span></label>
                                                <input placeholder="" type="text" name="PO" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
                                            </div>
                                        </div>
