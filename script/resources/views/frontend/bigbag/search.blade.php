...
@section('content')
    ...
    <section class="authentication-page pt-5 pb-4">
        <div class="container">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3">
                                ...
                                <form action="{{url('/')}}/product_search" class="form-header" method="get">
                                <div class="input-group">
 

                 <input type="text" name="src" class="form-control"
                                        placeholder="{{__('What are you Looking For?')}}" value="{{$search}}">


                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-solid"><i class="fa fa-search"></i>{{__('Search1')}}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
   ...
   <span style="text-align: center;color: red">{{__('There are no results for this search')}}</span>
</div>
