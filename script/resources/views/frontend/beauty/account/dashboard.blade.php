  ...
  <div class="dlab-bnr-inr overlay-primary" style="background-image:url({{ asset('frontend/beauty/images/banner/bnr1.jpg')}});">
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white">{{__('Account Details')}}  </h1>
                    <!-- Breadcrumb row -->
                    <div class="breadcrumb-row">
                        <ul class="list-inline">
                                                        <li><a href="{{url('/')}}">{{__('Home')}} </a></li>

                            <li>{{__('Account Details')}} </li>
                        </ul>
                    </div>
                    <!-- Breadcrumb row END -->
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <img src="{{ url('/')}}/uploads/{{ Auth::user()->id }}/photo.png ?? 'frontend/bigbag/images/profile.jpg') }}" class="mr-2" alt="photo here">
                     @else
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="checkout-form-list">
                                            ...
                                            <input placeholder="" type="text" value="{{ Auth::user()->mobile }}">
                                        </div>
                                    </div>
