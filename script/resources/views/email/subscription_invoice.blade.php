                                 ...
                                 https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                        ...
                                        <table class="purchase" width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h3 class="align-right">@if($info->status==1)
                                                            Approved @elseif($info->status==2) Pending @else
                                                            Declined  @endif</h3>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <h3 class="align-right">@if($info->payment_method->status==1)
                                                            Approved  @else Declined  @endif</h3>
                                                </td>
                                            </tr>
                                        ...
                                        <p class="f-fallback sub"><strong>Note:</strong>Your Domain Will be active within 24 hours</p>
                        ...
                        <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td class="content-cell" align="center">
                                    ...
                                    <p class="f-fallback sub align-center">&copy; {{ date('Y') }} {{ env('APP_NAME') }}.
