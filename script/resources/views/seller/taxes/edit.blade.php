 ...
 <div class="row">
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <form class="basicform" action="{{ route('seller.taxes.update',$tax->id) }}" method="post">
          @csrf
          @method('PUT')
        <div class="form-group row mb-4">
          <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" >{{ __('name') }}  </label>
          <div class="col-sm-12 col-md-7">
            <input type="text" class="form-control" required="" name="name" value="{{ $tax->name }}">
          </div>
        </div>
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                    <input type="text" class="form-control" required="" name="value" value="{{ $tax->value }}">
                </div>
            </div>
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                    <div class="switch">
                                        <label>
                                            <input name="status" onchange="update_active(this)"  type="checkbox" <?php if($tax->status == 1) echo "checked";?> >
