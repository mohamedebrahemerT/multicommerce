...
<div class="card"  >
	<div class="card-body">
		...
		<div class="card-action-filter">
			<form method="post" class="basicform_with_reload" action="{{ route('seller.users.destroy') }}">
				@csrf
				<div class="row">
					<div class="col-lg-6">
						<div class="d-flex">
					...
					<div class="col-lg-6">
						...
						<div class="add-new-btn">
							<a href="{{ route('seller.users.create') }}" class="btn btn-primary float-right">{{ __('Add New Employee') }}</a>
						</div>
						{{-- @endcan --}}
					</div>
				</div>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								{{-- @can('admin.edit')  --}}
								<div class="hover">
									<a href="{{ route('seller.users.edit',$row->id) }}">{{ __('Edit') }}</a>
