...
<html>
  <head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('uploads/w-logo.png') }}" />
    ...
    <div id="receipt-data">
        <div class="centered">
            @if($general_setting->site_logo)
                <img src="{{ asset('uploads/w-logo.png') }}" height="42" width="42" style="margin:10px 0;filter: brightness(0);">
            @endif
            
            <h2>{{$lims_biller_data->name}}</h2>
