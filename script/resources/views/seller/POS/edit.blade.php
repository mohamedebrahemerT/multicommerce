            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {{--                          {!! Form::open(['route' => ['POS.update', $lims_sale_data->id], 'method' => 'put', 'files' => true, 'id' => 'payment-form']) !!}
                        --}}



                 <form method="post" action="{{url('/')}}/seller/POS/{{$lims_sale_data->id}}/update" id="payment-form" enctype="multipart/form-data">
                    @csrf
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong>{{trans('Order Discount')}}</strong>
                                            </label>
