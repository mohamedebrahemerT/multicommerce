...
<div class="card"  >
	<div class="card-body">
		...
		<div class="card-action-filter">
			<form method="post" class="basicform_with_reload" action="{{ route('seller.roles.destroy') }}">
				@csrf
				<div class="row">
					<div class="col-lg-6">
						<div class="d-flex">
					...
					<div class="col-lg-6">
						...
						<div class="add-new-btn">
							<a href="{{ route('seller.role.create') }}" class="btn btn-primary float-right">{{ __('Add New Role') }}</a>
						</div>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<div class="hover">
									<a href="{{ route('seller.role.edit',$page->id) }}">{{ __('Edit') }}</a>
								</div>
							</td>
							<td>
								@foreach ($page->permissions as $perm)
								<span class="badge badge-primary mr-1 mb-2">
									{{ str_replace("admin", "employee",$perm->name)   }}
								</span>
								@endforeach
                                <hr>
							</td>
