                ...
                <div class="card-header">
                    <div class="col-sm-10">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if($type == 'ready-for-pickup') active @endif" href="{{ route('seller.orders.status','ready-for-pickup') }}">{{ __('Ready for pickup') }} <span class="badge badge-secondary">{{ $pickup }}</span></a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if($type == 'POS') active @endif" href="{{ route('seller.orders.status','POS') }}">{{ __('POS') }} <span class="badge badge-secondary">{{ $POS }}</span></a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-sm-2">
