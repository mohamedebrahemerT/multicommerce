        ...
        <form class="basicform" action="{{ route('seller.customer.update',$info->id) }}" method="post">
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              ...
              @if($info->status == 0 )
           <div class="form-group row mb-4">
            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" >{{ __('Reason For Ban') }}</label>
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" required="" name="ReasonForBan" value="{{ $info->ReasonForBan }}">
            </div>
          </div>
          @endif
  ...
  <optgroup label="Other countries">
    ...
    <option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
          ...
          <div class="col-sm-12 col-md-5">
            <input type="text" class="form-control" required="" value="{{ $info->mobile }}"  name="mobile" required>
          </div>
