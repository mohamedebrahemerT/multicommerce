                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <ul class="nav nav-pills flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="{{ url('seller/product/'.$info->id.'/price') }}"><i
                        ...
                        <div class="col-sm-9">
                            <form class="basicform" method="post"
                                  action="{{ route('seller.products.price',$info->price->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-3">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <label for="has_offer" class="mt-2">{{ __('Has Offer') }}</label>
                                    </div>
                                    <div class="form-group col-md-9 col-12">

                                        <label>
                                            <input type="checkbox" id="has_offer"
                                                   @if($info->price->special_price) {{ 'checked' }} @endif name="has_offer"
                                                   class="custom-switch-input sm" value="1">
                                            <span class="custom-switch-indicator"></span>
                                        </label>

                                    </div>
                                </div>
                                <div id="offer-details" style="display: none">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label for="special_price" class="mt-2">{{ __('Special Price') }}</label>
                                        </div>
                                        <div class="form-group col-md-9 col-12">
                                            <input type="number" value="{{ $info->price->special_price }}"
                                                   step="any"
                                                   class="form-control" id="special_price" placeholder=""
                                                   name="special_price">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-9 col-12">
                                            ...
                                            <select name="price_type" id="special_price_type"
                                                ...
                                                <option value="1"
                                                        @if($info->price->price_type === 1) selected @endif>{{ __('Fixed') }}</option>
                                                <option value="0"
                                                        @if($info->price->price_type === 0) selected @endif>{{ __('Percent') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label for="special_price_start"
                                                   class="mt-2">{{ __('Special Price Start') }}</label>
                                        </div>
                                        <div class="form-group col-md-9 col-12">
                                            <input type="date" class="form-control"
                                                   value="{{ $info->price->starting_date }}" id="special_price_start"
                                                   placeholder="" name="special_price_start">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label for="special_price_end"
                                                   class="mt-2">{{ __('Special Price End') }}</label>
                                        </div>
                                        <div class="form-group col-md-9 col-12">
                                            <input type="date" class="form-control" id="special_price_end"
                                                   value="{{ $info->price->ending_date }}" placeholder=""
...
@push('js')
    ...
    <Script>
        if ($("#has_offer").is(':checked')) {
            ...
            $('#offer-details').val(1);
            $('#offer-details').prop('required', true);
            $('#special_price').prop('required', true);
            $('#special_price_start').prop('required', true);
            $('#special_price_end').prop('required', true);
        ...
        $("#has_offer").on('change', function () {
            if ($("#has_offer").is(':checked')) {
                ...
                $('#offer-details').prop('required', false);
                $('#special_price').prop('required', false);
                $('#special_price_start').prop('required', false);
                $('#special_price_end').prop('required', false);
                $('#offer-details').val(0);
                $('#special_price').val(null);
                $('#special_price_start').val(null);
                $('#special_price_end').val(null);
            }
        });
    </Script>
