...
class ChildattributeController extends Controller
{
    ...
    {
         $limit=user_limit();
         $posts_count1=Category::where('user_id',getUserId())->where('type','child_attribute')->count();
         $posts_count2=Category::where('user_id',getUserId())->where('type','parent_attribute')->count();
