...
class PaymentController extends Controller
{
     public function __construct() {
        ...
        $this->middleware('AdminRole:paymentgeteway_show', [
            'only' => ['index', 'show'],
        ]);
        $this->middleware('AdminRole:paymentgeteway_add', [
            'only' => ['create', 'store'],
        ]);
        $this->middleware('AdminRole:paymentgeteway_edit', [
            'only' => ['edit', 'update'],
        ]);
        $this->middleware('AdminRole:paymentgeteway_delete', [
