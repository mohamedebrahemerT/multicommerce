...
class FrontendController extends Controller
{
        ...
        $this->middleware('AdminRole:FrontendSettings_show', [
            'only' => ['index', 'show'],
        ]);
        $this->middleware('AdminRole:FrontendSettings_add', [
            'only' => ['create', 'store'],
        ]);
        $this->middleware('AdminRole:FrontendSettings_edit', [
            'only' => ['edit', 'update'],
        ]);
        $this->middleware('AdminRole:FrontendSettings_delete', [
        ...
        if ($request->type=="features") {
            ...
            $meta->save();
                 ...
                 $description = json_encode([
                    'ar' => Str::slug($request->description_ar),
                    'en' => Str::slug($request->description_en),
                ]);
