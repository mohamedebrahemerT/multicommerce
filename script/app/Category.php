...
class Category extends Model
{
    ...
    protected $appends = ['name', 'name_ar', 'name_en','src',
        'slug',
//'slug_ar','slug_en'
    ];
    ...
    public function getNameAttribute()
    {
        ...
        if (isset($this->attributes['type']) && ($this->attributes['type'] == "banner_ads" ||
...
//    }
    ...
    {
        return $this->hasOne('App\Getway')->where('user_id', getUserId());
    }
