...
Route::get('/test-login', function (){
    return view('frontend.ecommerce.account.login');
});

Route::get('/test-dashboard', function (){
    return view('frontend.ecommerce.account.dashboard');
});
Route::get('/test-details', function (){
    return view('frontend.ecommerce.details');
});
...
Route::get('/test-wish', function (){
    return view('frontend.ecommerce.wishlist');
});

Route::get('/test-thank', function (){
    return view('frontend.ecommerce.thanks');
});

Route::get('/test-page', function (){
    return view('frontend.ecommerce.page');
});
...
///,'middleware' => 'checkdomainexpiration'
...
Route::group(['domain' => '{subdomain}.' . env('APP_PROTOCOLESS_URL')], function () {
    ...
    Route::get('/team', 'Beauty\FrontendController@team')->name('team');
    Route::get('/ourShop', 'Beauty\shopController@shop')->name('shop');
Route::get('/booking', 'Beauty\bookingController@index')->name('booking.index');

Route::get('/Book_now/{id}', 'Beauty\bookingController@Book_now')->name('booking.Book_now');
    ...
    Route::group(['namespace' => 'Frontend'], function () {
        ...
        Route::get('product/{slug}/{id}', 'FrontendController@detail')->name('product.view');
             ...
             Route::get('product/{id}', 'FrontendController@detail')->name('product.view');
        ...
        Route::get('/shop','FrontendController@getshop')->name('shop.getshop');

        Route::get('/more','FrontendController@more')->name('more.more');
        Route::post('/QuickView','FrontendController@QuickView');
            
        Route::post('termoptions_price', 'FrontendController@termoptions_price');

        Route::post('varent_selction', 'FrontendController@varent_selction');



     Route::post('termoptions_pricePOS', 'FrontendController@termoptions_pricePOS');

        Route::post('varent_selctionPOS', 'FrontendController@varent_selctionPOS');
        ...
        Route::get('/add_to_cartforent/{id}', 'CartController@add_to_cartforent');
        Route::get('/add_to_wishlist/{id}', 'CartController@add_to_wishlist');
        Route::post('/add_wishlist_new/{id}', 'CartController@add_wishlist');
        Route::post('/add_wishlist_new', 'CartController@add_wishlist_home');

        Route::get('/addtocart', 'CartController@cart_add');
        ...
        Route::post('/cartdestroy','CartController@destroy')->name('cart.destroy');
         ...
         Route::post('/RemoveCartFromHome','CartController@RemoveCartFromHome')->name('cart.RemoveCartFromHome');
        ...
        Route::post('cart_update/update','CartController@update')->name('cart.update');

        Route::post('/switchToSaveForLater','CartController@switchToSaveForLater');
        Route::post('/SaveForLaterdestroy','CartController@SaveForLaterdestroy')->name('cart.Deletelater');

        Route::post('/switchToCart', 'CartController@switchToCart');
        Route::post('/couponnstore','CouponsController@store');
        Route::delete('/coupondestroy','CouponsController@destroy');
        ...
        Route::post('/get_shop_products', 'FrontendController@get_shop_products');

         Route::get('/get_shop_products_my_range_price', 'FrontendController@get_shop_products_my_range_price');
        ...
        Route::get('/checkout', 'FrontendController@checkout')->middleware('customer');

        Route::get('/guestCheckout', 'FrontendController@checkout');


        Route::post('/make-review/{id}', 'ReviewController@store')->middleware('auth');
        Route::get('/DeleteReview/{id}', 'ReviewController@destroy')->middleware('auth');
        ...
        Route::group(['prefix' => 'user'], function () {
            ...
            Route::post('/addresses', 'UserController@addresses_post');
            Route::post('/addresses_update', 'UserController@addresses_update');
            Route::get('/addresses_delate', 'UserController@addresses_trash');

            Route::get('/dashboard', 'UserController@dashboard')->middleware('customer');
            Route::get('/addresses', 'UserController@addresses')->middleware('customer');
            Route::get('/payment', 'UserController@payment')->middleware('customer');

            Route::get('/orders', 'UserController@orders')->middleware('customer');
            Route::get('/orders/{type}', 'UserController@type')->middleware('customer');


            Route::get('/order/view/{id}', 'UserController@order_view')->middleware('auth');//->middleware('customer');


        Route::get('/order/viewQR/{id}', 'UserController@order_viewQR');

            Route::post('/order/submit-refund', 'UserController@submit_request_refund')->middleware('customer');
            Route::get('/order/refund/{order_code}/{id}', 'UserController@request_refund')->middleware('customer');
...
Route::resource('AdminGroup', 'AdminGroupController');
    ...
    Route::resource('counteries', 'CounteriesController');
    Route::resource('cities', 'CitiesController');
    Route::resource('states', 'StatesController');
    Route::get('get_city', 'StatesController@get_city');
    ...
    Route::get('CpanelCredentials', 'SiteController@CpanelCredentials')->name('site.CpanelCredentials');
    
 Route::post('CpanelCredentials_update', 'SiteController@CpanelCredentials_update')->name('CpanelCredentials.update');
...
Route::group(['as' => 'seller.', 'prefix' => 'seller', 'namespace' => 'Seller', 'middleware' => ['auth', 'seller']], function () {
    ...
    Route::resource('StoreGroup', 'StoreGroupController');
                 
    
    //booking_schedule
    Route::resource('booking_schedule', 'BookingScheduleController');
    Route::put('booking_options/update/{id}', 'BookingScheduleController@updateBookingOption')->name('booking_options.update');
    Route::get('calender', 'CalenderController@index');
    Route::post('calenderAjax', 'CalenderController@ajax');

    Route::post('sales/sale-data', 'POSController@saleData');
    Route::post('sales/sendmail', 'POSController@sendMail')->name('sale.sendmail');
    Route::get('sales/sale_by_csv', 'POSController@saleByCsv');
    Route::get('sales/product_sale/{id}','POSController@productSaleData');
    Route::post('importsale', 'POSController@importSale')->name('sale.import');
    Route::get('pos', 'POSController@posSale')->name('sale.pos');
    Route::get('sales/lims_sale_search', 'POSController@limsSaleSearch')->name('sale.search');

    Route::get('sales/lims_product_search', 'POSController@limsProductSearch')->name('product_sale.search');
    
    Route::get('sales/getcustomergroup/{id}', 'POSController@getCustomerGroup')->name('sale.getcustomergroup');
    Route::get('sales/getproduct/{id}', 'POSController@getProduct')->name('sale.getproduct');
    Route::get('sales/getproduct/{category_id}/{brand_id}', 'POSController@getProductByFilter');
    Route::get('sales/getfeatured', 'POSController@getFeatured');
    Route::get('sales/get_gift_card', 'POSController@getGiftCard');
    Route::get('sales/paypalSuccess', 'POSController@paypalSuccess');
    Route::get('sales/paypalPaymentSuccess/{id}', 'POSController@paypalPaymentSuccess');
    Route::get('sales/gen_invoice/{id}', 'POSController@genInvoice')->name('sale.invoice');
    Route::post('sales/add_payment', 'POSController@addPayment')->name('sale.add-payment');
    Route::get('sales/getpayment/{id}', 'POSController@getPayment')->name('sale.get-payment');
    Route::post('sales/updatepayment', 'POSController@updatePayment')->name('sale.update-payment');
    Route::post('sales/deletepayment', 'POSController@deletePayment')->name('sale.delete-payment');
    Route::get('sales/{id}/create', 'POSController@createSale');
    Route::post('sales/deletebyselection', 'POSController@deleteBySelection');
    Route::get('sales/print-last-reciept', 'POSController@printLastReciept')->name('sales.printLastReciept');
    Route::get('sales/today-sale', 'POSController@todaySale');
    Route::get('sales/today-profit/{warehouse_id}', 'POSController@todayProfit');
    Route::resource('POS', 'POSController');
    Route::post('get_variant', 'POSController@get_variant');


    Route::post('POS/destroy/{id}', 'POSController@destroy');
    Route::post('POS/{id}/update', 'POSController@update');
    Route::get('/all_sales', 'POSController@all_sales');
    Route::get('/setting/pos_setting', 'POSController@all_sales');
    Route::post('customer_store', 'POSController@customer_store');



 Route::get('setting/pos_setting', 'POSController@posSetting')->name('setting.pos');
 Route::post('setting/pos_setting_store', 'POSController@posSettingStore')->name('setting.pos');



    /////////////////////////////////////////////////////////////// POSbeauty
    Route::get('POSbeauty', 'POSbeautyController@POSbeauty');
    Route::post('addservice', 'POSbeautyController@addservice');
    Route::post('EmptyCart', 'POSbeautyController@EmptyCart');
    Route::post('Removeservices', 'POSbeautyController@Removeservices');
    Route::post('POSbeauty', 'POSbeautyController@POS');
    Route::post('apply_coupon', 'POSbeautyController@apply_coupon');
    Route::post('filter-services', 'POSbeautyController@filter_services');

    Route::post('filter-POSBeautyType', 'POSbeautyController@filter_POSBeautyType');
    
    Route::post('location-filter', 'POSbeautyController@location_filter');
    Route::post('search_key', 'POSbeautyController@search_key'); 
     


    /////////////////////////////////////////////////////////////// POSbeauty
    Route::get('getPOSShope', 'POSShopeController@POSShope');
    Route::post('Shopeaddservice', 'POSShopeController@addservice');
    Route::post('ShopeEmptyCart', 'POSShopeController@EmptyCart');
    Route::post('ShopeRemoveservices', 'POSShopeController@Removeservices');
    Route::post('xxxxxx', 'POSShopeController@POS');
    Route::post('Shopeapply_coupon', 'POSShopeController@apply_coupon');
    Route::post('Shopefilter-services', 'POSShopeController@filter_services');
    Route::post('Shopelocation-filter', 'POSShopeController@location_filter');
    Route::post('Shopesearch_key', 'POSShopeController@search_key');
     ////////////////////////////////////////////////////////////////
   ...
   // Route::get('cash-register/check-availability/{warehouse_id}', 'CashRegisterController@checkAvailability')->name('cashRegister.checkAvailability');
    ...
    Route::post('cash-register/close', 'CashRegisterController@close')->name('cashRegister.close');
     ...
     //roles
     Route::resource('role', 'SellerRoleController');
     Route::post('roles/destroy', 'SellerRoleController@destroy')->name('roles.destroy');
     //users
     Route::resource('users', 'EmployeeController');
     Route::post('/userss/destroy', 'EmployeeController@destroy')->name('users.destroy');
    ...
    Route::post('branches/destroy', 'branchesController@destroy')->name('branches.destroy');
    ...
    Route::post('taxes/destroy', 'taxesController@destroy')->name('taxes.destroy');

Route::post('/cities/actived', 'taxesController@update_Actived')->name('cities.actived');   
    ...
    Route::get('report/taxes', 'ReportController@taxes')->name('report.taxes');
               
Route::post('/taxes/actived', 'taxesController@update_Actived')->name('taxes.actived');   
    ...
    Route::get('refund/{type}', 'OrderController@getRefund')->name('refund.status');
    Route::get('refund/taxes/{type}', 'OrderController@getRefundtaxes')->name('refund.taxes');
    Route::get('refund/show/{id}', 'OrderController@showRefund')->name('refund.show');
    ...
    Route::post('orders/change-refund-status', 'OrderController@destroyRefund')->name('orders.refund.change-status-method');
...
Route::get('/page/{slug}', 'FrontendController@page');
Route::get('/page1/{slug}', 'FrontendController@page1');

Route::get('/about', 'FrontendController@about');
Route::get('/Terms_and_Conditions', 'FrontendController@Terms_and_Conditions');

Route::get('/Goods_Return_Policy', 'FrontendController@Goods_Return_Policy');
...
Route::get('/clear-cache', function() {
    ...
    Route::post('/login_seller_admin', 'FrontendController@login_seller_admin');

Route::get('Email_verfiy/{token}', 'FrontendController@Email_verfiy');
Route::get('Email_verfiy_user/{token}', 'Frontend\UserController@Email_verfiy');

Route::post('postverfiy', 'FrontendController@postverfiy');
Route::post('postverfiy_user', 'Frontend\UserController@postverfiy');

Route::post('request_new_code_user', 'Frontend\UserController@request_new_code');

Route::post('UserVisa', 'Frontend\UserController@UserVisa');
Route::get('deleteUserVisa/{id}', 'Frontend\UserController@deleteUserVisa');

                  
    Route::get('user/orders/invoice/{id}', 'Frontend\UserController@invoice')->name('invoice');
    Route::get('user/reviews', 'Frontend\ReviewController@reviews')->name('reviews');
        Route::get('/make-review_edit', 'Frontend\ReviewController@edit')->middleware('auth');
        Route::post('/user/make-review_edit', 'Frontend\ReviewController@update')->middleware('auth');
